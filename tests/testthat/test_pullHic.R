...
test_that("GInteractions correctly map to blocks", {
    x <-
        GInteractions(
            ...
            GRanges(
                seqnames = c(rep("chr1", 4), "chr2"),
                ranges = IRanges(
                    start = c(0, 30, 40, 10, 10),
